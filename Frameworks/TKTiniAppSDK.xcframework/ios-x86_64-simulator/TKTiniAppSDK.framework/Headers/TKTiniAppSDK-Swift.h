...
#ifndef TKTINIAPPSDK_SWIFT_H
#define TKTINIAPPSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TKTiniAppSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12TKTiniAppSDK20TiniAppConfiguration")
...
SWIFT_CLASS("_TtC12TKTiniAppSDK10TiniAppSDK")
...
SWIFT_PROTOCOL("_TtP12TKTiniAppSDK18TiniAppSDKDelegate_")
@protocol TiniAppSDKDelegate
...
- (void)openPaymentWithTransactionId:(NSString * _Nonnull)transactionId completedHandler:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completedHandler;
@end

@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC12TKTiniAppSDK21TiniAppViewController")
...
SWIFT_CLASS("_TtC12TKTiniAppSDK8TiniUser")
